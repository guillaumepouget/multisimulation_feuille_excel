...
#
RES1=$(sbatch --parsable --nodes=1 --cpus-per-task=1 jobSLURM_1.sh $rep_multisimu $stics_version $javastics_path $option_effacement_fichiers)
...
sbatch --dependency=afterany:$RES2 --nodes=1 --cpus-per-task=1 jobSLURM_3.sh $rep_multisimu $ncoeurs $option_effacement_fichiers
